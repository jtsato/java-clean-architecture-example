...
import io.github.jtsato.bookstore.core.book.action.RegisterBookAction;
...
class RegisterBookUseCaseTest {
    ...
    @InjectMocks
    private final RegisterBookUseCase registerBookUseCase = new RegisterBookAction(registerBookGateway,
