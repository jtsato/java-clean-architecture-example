...
class UpdateBookByIdUseCaseTest {
    ...
    void failToUpdateABookIfParametersAreNotValid() {
        ...
        final Exception exception = Assertions.assertThrows(Exception.class, () -> {
            new UpdateBookByIdParameters(null, StringUtils.SPACE, null);
        });
    ...
    private Book mockUpdateBookByIdGatewayParameters() {
        ...
        return new Book(1L, "Effective Java (2nd Edition)", null, author);
    }

    private Optional<Book> mockUpdateBookByIdGatewayReturn() {
        final Author author = new Author(1L, "Joshua Bloch", Gender.MALE, LocalDate.parse("1961-08-28"));
        return Optional.of(new Book(1L, "Effective Java (2nd Edition)", null, author));
    }
    ...
    private void updateBookById() {
        ...
        final UpdateBookByIdParameters parameters = new UpdateBookByIdParameters(1L, "Effective Java (2nd Edition)", 1L);
    ...
    private Optional<Book> mockGetBookByTitleGatewayWithOtherId() {
        final Author author = new Author(1L, "Joshua Bloch", Gender.MALE, LocalDate.parse("1961-08-28"));
        return Optional.of(new Book(2L, "Effective Java (2nd Edition)", null, author));
    }
