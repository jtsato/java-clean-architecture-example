...
class UpdateBookByIdUseCaseTest {
    ...
    @InjectMocks
    private UpdateBookByIdUseCase updateBookByIdUseCase = new UpdateBookByIdUseCaseImpl(updateBookByIdGateway, getAuthorByIdGateway, getBookByTitleGateway, getLocalDateTime);
    ...
    private Book mockUpdateBookByIdGatewayParameters() {
        ...
        return new Book(1L, author, "Effective Java (2nd Edition)", BigDecimal.valueOf(10.00), Boolean.TRUE, null, LocalDateTime.parse("2020-04-12T22:04:59.123"));
    }
    ...
    private void updateBookById() {
        ...
        final UpdateBookByIdParameters parameters = new UpdateBookByIdParameters(1L, 1L, "Effective Java (2nd Edition)", BigDecimal.valueOf(10.00), Boolean.TRUE);
    ...
    private Optional<Book> mockGetBookByTitleGatewayWithOtherId() {
        final Author author = new Author(1L, "Joshua Bloch", Gender.MALE, LocalDate.parse("1961-08-28"));
        return Optional.of(new Book(2L, author, "Effective Java (2nd Edition)", BigDecimal.valueOf(10.00), Boolean.TRUE, LocalDateTime.parse("2020-03-12T22:04:59.123"), LocalDateTime.parse("2020-04-12T22:04:59.123")));
    }
