...
class FindBooksByIdsUseCaseTest {
    ...
    @Mock
    private FindBooksByIdsGateway findBooksByIdsGateway = Mockito.mock(FindBooksByIdsGateway.class);

    @InjectMocks
    private FindBooksByIdsUseCase findBooksByIdsUseCase = new FindBooksByIdsUseCaseImpl(findBooksByIdsGateway);
    ...
    void successfulToFindBooksByIdsIfFound() {
        ...
        when(findBooksByIdsGateway.findBooksByIds(ids)).thenReturn(mockFindBooksByIdsGatewayReturn());
