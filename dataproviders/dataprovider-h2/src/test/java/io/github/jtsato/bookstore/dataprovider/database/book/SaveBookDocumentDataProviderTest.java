...
class SaveBookDocumentDataProviderTest {
	...
	void successfulToSaveBookDocumentIfParametersAreValid() {
		...
		final BookDocument bookDocument = new BookDocument(null, 1L, "text/plain", "txt", "Document", 123L,
		...
		assertThat(result.getContent()).isEqualTo("Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.");
