...
author.id==1 author.name=='Emma Williams' author.gender==FEMALE author.startBirthdate==1981-09-04 author.endBirthdate==1983-09-04 page==0 size==10 sort==title sort==creationDate,desc Accept-Language:pt_BR 'Authorization:'"$token"'' 