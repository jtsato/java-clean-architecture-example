...
class RegisterBookControllerTest {
    ...
    private RegisterBookParameters mockRegisterBookUseCaseParameters() {
        return new RegisterBookParameters("Effective Java (2nd Edition)", 1L);
    }
    ...
    private String buildRequestBody()
        ...
        final RegisterBookRequest request = new RegisterBookRequest("Effective Java (2nd Edition)", 1L);
