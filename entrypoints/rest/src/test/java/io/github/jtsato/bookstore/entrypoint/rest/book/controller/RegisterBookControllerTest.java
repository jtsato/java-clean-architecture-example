...
class RegisterBookControllerTest {
    ...
    private RegisterBookParameters mockRegisterBookUseCaseParameters() {
        return new RegisterBookParameters("Effective Java (2nd Edition)", 1L, BigDecimal.valueOf(10.00));
    }
    ...
    private String buildRequestBody()
        ...
        final RegisterBookRequest request = new RegisterBookRequest("Effective Java (2nd Edition)", BigDecimal.valueOf(10.00), 1L);
