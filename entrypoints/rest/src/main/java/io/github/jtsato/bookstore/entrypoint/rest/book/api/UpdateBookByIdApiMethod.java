...
@Tag(name = "Books")
@FunctionalInterface
public interface UpdateBookByIdApiMethod {
    ...
    UpdateBookByIdResponse execute(@Parameter(description = "Book Id") final Long id, final UpdateBookByIdRequest request);
}
